...
import { getAllPages, getActivityLogs } from "@/lib/auth"
import { LayoutDashboard, FileText, Edit, Eye, Clock, ArrowLeft, Palette, Globe, BarChart3, Zap } from "lucide-react"
...
type EditorPage = "dashboard" | "pages" | "editor" | "page-view" | "page-edit"
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <button
                  onClick={() => pages.length > 0 && handleEditPage(pages[0])}
